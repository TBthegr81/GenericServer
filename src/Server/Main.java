 ...
 * but needs actuall server-code to use these functions.
 * 
 * I made this after completing a group-project in school where i was responsible for the server-side
